...
В данной лабораторной работе изучены основы работы с DOM (Document Object Model) и событиями в JavaScript.

### Что изучили:

- **Работа с DOM-деревом** - объектной моделью HTML-документа
- **Поиск HTML-элементов** из JavaScript с помощью методов:
  - `getElementById()` - поиск по уникальному идентификатору
  - `querySelector()` - универсальный поиск по CSS-селектору
- **Изменение содержимого страницы** - текста, HTML-разметки, атрибутов
- **Управление стилями** элементов через JavaScript
- **Обработка событий пользователя** - клики, ввод текста, отправка форм
- **Создание динамических элементов** - добавление и удаление элементов DOM
- **Валидация форм** - проверка корректности введённых данных
- **Делегирование событий** - эффективная обработка событий динамических элементов

## Структура проекта
*  README.md -  документация лабы 
*  index.html - основной html
*  style.css - файл стилей
*  main.js - основной js файл
*  dynamicElements.html - html  для демонстрации динамического создания элементов
*  dynamicElements.js - js для создания и удаления элементов динамически
